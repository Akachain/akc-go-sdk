...
func (t *SimpleChaincode) readMarblePrivateDetails(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	name = args[0]
	valAsbytes, err := stub.GetPrivateData("collectionMarbles", name) //get the marble private details from chaincode state
	if err != nil {
...
func (t *SimpleChaincode) getMarblesByRange(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	fmt.Println("- do nothing")
	fmt.Println("- end getMarblesByRange (success)")
	return shim.Success(nil)
}
...
func (t *SimpleChaincode) queryMarblesByOwner(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	fmt.Println("- do nothing")
	fmt.Println("- end queryMarblesByOwner (success)")
	return shim.Success(nil)
}
...
func (t *SimpleChaincode) queryMarbles(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	fmt.Println("- start queryMarbles")
	fmt.Println("- do nothing")
	fmt.Println("- end queryMarbles(success)")
	return shim.Success(nil)
}
...
func getQueryResultForQueryString(stub shim.ChaincodeStubInterface, queryString string) ([]byte, error) {
	...
	fmt.Println("- start getQueryResultForQueryString")
	fmt.Println("- do nothing")
	fmt.Println("- end getQueryResultForQueryString (success)")
	return nil, nil
}
